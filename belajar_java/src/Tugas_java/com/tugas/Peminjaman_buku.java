...
do
{
System.out.println("\t\t*** PERPUS SMKN 4 PAYAKUMBUH ***");
...
System.out.print("NISN : ");mhs[jmlmhs][0]= input.nextInt();
System.out.println("1. PPLG");
System.out.println("2. TJKT");
System.out.println("3. DKV");
System.out.println("4. BC");
...
if(mhs[i][1] == 1)
{
System.out.print("PPLG");
}
else if(mhs[i][1] == 2)
{
System.out.print("TJKT");
}
else if(mhs[i][1] == 3)
{
...
int npm;
int ts;
System.out.println("\nMasukan NISN\t: ");npm = input.nextInt();
for(int i = 0; i < jmlmhs; i++)
{
if(npm == mhs[i][0])
{
